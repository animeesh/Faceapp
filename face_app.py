...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        self.window.title("Employe Regestration ")
        ...
        header = tk.Label(self.window, text="Employee Monitoring Registration", width=80, height=2, fg="grey", bg="#ffe599",
                          font=('times', 18, 'bold', 'underline'))
        header.place(x=0, y=0)

        #client Id
        PS_Number = tk.Label(self.window, text="PS Number", width=10, height=2, fg="white", bg="#e69138", font=('times', 15))
        PS_Number.place(x=80, y=80)

        displayVariable = StringVar()
        self.PS_NumberTxt = tk.Entry(self.window, width=20, text=displayVariable, bg="white", fg="black",
                               font=('times', 15, 'bold'))
        self.PS_NumberTxt.place(x=205, y=80)
        ...
        #emp name
        empName = tk.Label(self.window, text="Emp Name", width=10, fg="white", bg="#e69138", height=2, font=('times', 15))
        ...
        """emailId = tk.Label(self.window, text="Email ID :", width=10, fg="white", bg="#e69138", height=2, font=('times', 15))
        ...
        #mobile number
        mobileNo = tk.Label(self.window, text="Mobile No :", width=10, fg="white", bg="#e69138", height=2,
                            font=('times', 15))
        ...
        lbl3 = tk.Label(self.window, text=" Note : ", width=15, fg="#606060", bg="#D6ED17", height=2,
                        font=('times', 15))
        self.message = tk.Label(self.window, text="Look straight to in cammera", bg="white", fg="black", width=30, height=1,
                                activebackground="#e47911", font=('times', 15))
        self.message.place(x=220, y=220)
        lbl3.place(x=80, y=260)

        self.message = tk.Label(self.window, text=" Have a good day ", bg="#606060", fg="#D6ED17", width=58, height=2, activebackground="#bbc7d4",
                           font=('times', 15))
        ...
        takeImg = tk.Button(self.window, text="Take Images", command=self.collectUserImageForRegistration, fg="#D6ED17", bg="#606060", width=15,
                            height=2,
                            activebackground="#118ce1", font=('times', 15, ' bold '))
        takeImg.place(x=80, y=350)

        trainImg = tk.Button(self.window, text="Train Images", command=self.trainModel, fg="#D6ED17", bg="#606060", width=15,
                             height=2,
                             activebackground="#118ce1", font=('times', 15, ' bold '))
        trainImg.place(x=350, y=350)

        predictImg = tk.Button(self.window, text="Predict", command=self.makePrediction, fg="#D6ED17", bg="#606060",
                             width=15,
                             height=2,
                             activebackground="#118ce1", font=('times', 15, ' bold '))
        predictImg.place(x=600, y=350)

        quitWindow = tk.Button(self.window, text="Quit", command=self.close_window, fg="white", bg="#e98115", width=10, height=2,
                               activebackground="#118ce1", font=('times', 15, 'bold'))
    ...
    def collectUserImageForRegistration(self):
        clientIDVal = (self.PS_NumberTxt.get())
